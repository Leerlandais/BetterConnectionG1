...
CREATE TABLE IF NOT EXISTS `BetterConnectionG1`.`user` (
  ...
  UNIQUE INDEX `theemail_UNIQUE` (`theemail` ASC) VISIBLE,
  UNIQUE INDEX `useruniqid_UNIQUE` (`useruniqid` ASC) VISIBLE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `BetterConnectionG1`.`news` (
  ...
  INDEX `fk_news_user1_idx` (`user_iduser` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `BetterConnectionG1`.`news_has_category` (
  ...
  INDEX `fk_news_has_category_category1_idx` (`category_idcategory` ASC) VISIBLE,
  INDEX `fk_news_has_category_news_idx` (`news_idnews` ASC) VISIBLE,
